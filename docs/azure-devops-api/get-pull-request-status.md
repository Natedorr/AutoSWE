# Pull Request Statuses - Get - REST API (Azure DevOps Git)

Source: https://learn.microsoft.com/en-us/rest/api/azure/devops/git/pull-request-statuses/get?view=azure-devops-rest-7.1
...
| statusId | path | True | integer (int32) | ID of the pull request status. |
