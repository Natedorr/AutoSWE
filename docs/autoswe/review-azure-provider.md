...
- `set_status` tag handling (:352–395): strips caller-supplied
  ...
  only cost is a GET+PATCH per status transition (2 calls vs 1 on GitHub's  labels API), which at current volume is noise.
