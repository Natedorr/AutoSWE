...
Confirm you’ve set up Codex Cloud first. If not, seeCodex Cloud[Codex
Cloud](/codex/cloud)to get started.

## 1. Access and environment

Codex Security scans GitHub repositories connected throughCodex Cloud[Codex Cloud](/codex/cloud).

- Confirm your workspace has access to Codex Security.
- Confirm the repository you want to scan is available in Codex Cloud.

Go toCodex environments[Codex environments](https://chatgpt.com/codex/settings/environments)and check whether the repository already has an environment. If it doesn’t, create one there before continuing.Open environments[Open environments](https://chatgpt.com/codex/settings/environments)[Codex environments](/_astro/create_environment.M-EPszPH.png)

## 2. New security scan

After the environment exists, go toCreate a security scan[Create a security scan](https://chatgpt.com/codex/security/scans/new)and choose the repository you just connected.Create a security scan[Create a security scan](https://chatgpt.com/codex/security/scans/new)
...
- Click**Create**.[Create a security scan](/_astro/create_scan.mEjmf4U_.png)
...
## 4. Review scans and improve the threat modelReview scans[Review scans](https://chatgpt.com/codex/security/scans)[Threat model editor in Codex Security](/_astro/review_threat_model.JTLMQEmx.png)
...
For a deeper explanation of threat models and how they affect criticality and triage, seeImproving the threat model[Improving the threat model](/codex/security/threat-model).

## 5. Review findings and patch

After the initial backfill completes, review findings from the**Findings**view.Open findings[Open findings](https://chatgpt.com/codex/security/findings)
...
You can review each finding and create a PR directly from the finding detail page.Review findings and create a PR[Review findings and create a PR](https://chatgpt.com/codex/security/findings)

## Related docs

- Codex Security[Codex Security](/codex/security)gives the product overview.
- FAQ[FAQ](/codex/security/faq)covers common questions.
- Improving the threat model[Improving the threat model](/codex/security/threat-model)explains how to improve scan context and finding prioritization.