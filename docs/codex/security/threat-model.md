...
To review or update the threat model, go toCodex Security scans[Codex Security scans](https://chatgpt.com/codex/security/scans), open the repository, and click**Edit**.

## Related docs

- Codex Security setup[Codex Security setup](/codex/security/setup)covers repository setup and findings review.
