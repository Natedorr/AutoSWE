...
This page covers Codex Security, the product that scans connected GitHub repositories for likely security issues. For Codex sandboxing, approvals, network controls, and admin settings, seeAgent approvals & security[Agent approvals &
...
- Codex Security setup[Codex Security setup](/codex/security/setup)covers setup, scanning, and findings review.
- FAQ[FAQ](/codex/security/faq)covers common product questions.
- Improving the threat model[Improving the threat model](/codex/security/threat-model)explains how to tune scope, attack surface, and criticality assumptions.