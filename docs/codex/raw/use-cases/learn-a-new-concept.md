...
# Contents
← All use cases[← All use cases](/codex/use-cases)Copy pageExport as PDF[Export as PDF](/codex/use-cases/learn-a-new-concept/?export=pdf)
...
If you’re learning about an internal concept, you can connect multiple sources withplugins[plugins](/codex/plugins)to create a knowledge base.
