...
The next sections cover using Codex in the ChatGPT mobile app to control a Codex App host. To connect Codex to a project on an SSH host, seeconnect to an SSH host[connect to an SSH host](#connect-to-an-ssh-host).[Codex mobile setup screen alongside the ChatGPT mobile Codex project list](/images/codex/app/mobile-setup-light.webp)[Codex mobile setup screen alongside the ChatGPT mobile Codex project list](/images/codex/app/mobile-setup-dark.webp)[Codex mobile setup screen alongside the ChatGPT mobile Codex project list](/images/codex/app/mobile-setup-light.webp)[Codex mobile setup screen alongside the ChatGPT mobile Codex project list](/images/codex/app/mobile-setup-dark.webp)
...
In Codex on the host, use**Settings > Connections**to manage connected devices. You can also choose whether to keep the computer awake, enable Computer Use, or install the Chrome extension.[Connections settings showing devices that can control this Mac and remote access settings](/images/codex/app/mobile-control-this-mac-framed-light.webp)[Connections settings showing devices that can control this Mac and remote access settings](/images/codex/app/mobile-control-this-mac-framed-dark.webp)[Connections settings showing devices that can control this Mac and remote access settings](/images/codex/app/mobile-control-this-mac-framed-light.webp)[Connections settings showing devices that can control this Mac and remote access settings](/images/codex/app/mobile-control-this-mac-framed-dark.webp)
...
For SSH setup details, seeconnect to an SSH host[connect to an SSH host](#connect-to-an-ssh-host).
...
In Codex on the laptop, use**Settings > Connections > Control other devices**to add the other host. A device can allow remote access and control another device at the same time.[Connections settings showing another device available under Control other devices](/images/codex/app/mobile-control-other-devices-framed-light.webp)[Connections settings showing another device available under Control other devices](/images/codex/app/mobile-control-other-devices-framed-dark.webp)[Connections settings showing another device available under Control other devices](/images/codex/app/mobile-control-other-devices-framed-light.webp)[Connections settings showing another device available under Control other devices](/images/codex/app/mobile-control-other-devices-framed-dark.webp)
...
````Host devboxHostName devbox.example.comUser youIdentityFile ~/.ssh/id_ed25519````
...
- Codex App[Codex App](/codex/app)
- Codex App features[Codex App features](/codex/app/features)
- Codex App settings[Codex App settings](/codex/app/settings)
- Computer Use[Computer Use](/codex/app/computer-use)
- Chrome extension[Chrome extension](/codex/app/chrome-extension)
- Command line options[Command line options](/codex/cli/reference)
- Authentication[Authentication](/codex/auth)