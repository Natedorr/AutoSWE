...
- [Live E2E suite](tests/e2e/README.md) — `tests/e2e/` is a corpus of test cases (issue + expected process) that an agent drives against a real GitHub/Azure test project
